...
public interface AdminService {
    ...
    ResponseEntity<? super DeleteExclusionOwnerSignUpResponseDto> exclutionSignUp(Long ownerId);
    ...
    ResponseEntity<? super GlampingExclutionResponseDto> exclutionGlamping(Long glampId);
