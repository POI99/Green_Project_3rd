...
import com.green.glampick.repository.RoomImageRepository;
...
public class AdminModule {
    ...
    // 파일 삭제
    public static void deleteImageOne(Long bannerId, BannerRepository bannerRepository, CustomFileUtils customFileUtils) {
